...
namespace Lacrima
{
	...
	std::shared_ptr<Lacrima::ImGuiImage> EditorUI::loadImGuiImageFromImageViewSampler(const VmaImageViewSampler& image_view_sampler)
	{
		std::shared_ptr<ImGuiImage> image = std::make_shared<ImGuiImage>();
	...
	std::shared_ptr<Lacrima::ImGuiImage> EditorUI::getImGuiImageFromCache(const URL& url)
	{
