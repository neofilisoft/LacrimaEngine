...
RTTR_REGISTRATION
{
rttr::registration::class_<Lacrima::AnimatorComponent>("AnimatorComponent")
	 .property("skeleton", &Lacrima::AnimatorComponent::m_skeleton)
	 .property("playing", &Lacrima::AnimatorComponent::m_playing)
	 .property("paused", &Lacrima::AnimatorComponent::m_paused)
	 .property("loop", &Lacrima::AnimatorComponent::m_loop)
	 .property("time", &Lacrima::AnimatorComponent::m_time);
}

CEREAL_REGISTER_TYPE(Lacrima::AnimatorComponent)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Lacrima::Component, Lacrima::AnimatorComponent)
