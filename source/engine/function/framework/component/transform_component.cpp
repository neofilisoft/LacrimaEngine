...
RTTR_REGISTRATION
{
rttr::registration::class_<Lacrima::TransformComponent>("TransformComponent")
	 .property("position", &Lacrima::TransformComponent::m_position)
	 .property("rotation", &Lacrima::TransformComponent::m_rotation)
	 .property("scale", &Lacrima::TransformComponent::m_scale);
}

CEREAL_REGISTER_TYPE(Lacrima::TransformComponent)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Lacrima::Component, Lacrima::TransformComponent)
