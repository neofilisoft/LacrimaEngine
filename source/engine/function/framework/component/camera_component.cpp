...
RTTR_REGISTRATION
{
rttr::registration::class_<Lacrima::CameraComponent>("CameraComponent")
	 .property("fovy", &Lacrima::CameraComponent::m_fovy)
	 .property("near", &Lacrima::CameraComponent::m_near)
	 .property("far", &Lacrima::CameraComponent::m_far)
	 .property("move_speed", &Lacrima::CameraComponent::m_move_speed)
	 .property("turn_speed", &Lacrima::CameraComponent::m_turn_speed)
	 .property("zoom_speed", &Lacrima::CameraComponent::m_zoom_speed)
	 .property("exposure", &Lacrima::CameraComponent::m_exposure);
}

CEREAL_REGISTER_TYPE(Lacrima::CameraComponent)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Lacrima::Component, Lacrima::CameraComponent)
