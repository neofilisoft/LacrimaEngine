...
RTTR_REGISTRATION
{
rttr::registration::class_<Lacrima::SkyLightComponent>("SkyLightComponent")
	 .property("texture_cube", &Lacrima::SkyLightComponent::m_texture_cube);
}

CEREAL_REGISTER_TYPE(Lacrima::SkyLightComponent)
CEREAL_REGISTER_POLYMORPHIC_RELATION(Lacrima::LightComponent, Lacrima::SkyLightComponent)
