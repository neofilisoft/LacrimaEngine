...
namespace Lacrima
{
    class EngineContext
    {
        public:
            ...
            const auto& audioSystem() { return m_audio_system; }
            const auto& inputSystem() { return m_input_system; }
        ...
        private:
            ...
            std::shared_ptr<class AudioSystem> m_audio_system;
            std::shared_ptr<class InputSystem> m_input_system;
